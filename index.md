...
Ingrid Health is a private, non-commercial integration for personal health-data analysis.

The application accesses Google Health data using two read-only permissions:
